...
def backup_parcels_collection(db):
    ...
    print("\n[STEP 1] Backing up parcels collection...")
    ...
    try:
        ...
        if not parcels_collection:
            print("[INFO] No parcels collection found - nothing to backup")
            return
        ...
        if count == 0:
            print("[INFO] Collection is empty - nothing to backup")
            return
        ...
        print(f"[SUCCESS] Backup completed: {backup_file}")
...
def drop_all_collections(db):
    ...
    print("\n[STEP 2] Dropping all existing collections...")
    
    try:
        collection_names = db.list_collection_names()
        
        if not collection_names:
            print("[INFO] No collections found - nothing to drop")
            return
        ...
        print("[SUCCESS] All collections dropped successfully")
        
    except Exception as e:
        print(f"[ERROR] Error dropping collections: {e}")

def create_new_collections(db):
    """Create new collections with proper indexes"""
    print("\n[STEP 3] Creating new collections with indexes...")
    ...
    try:
        ...
        print("[SUCCESS] All collections and indexes created successfully")
...
def show_storage_info(client, db_name):
    ...
    print("\n[STORAGE INFO] Database Storage Information:")
    ...
    try:
        ...
        if used_percentage > 80:
            print("[WARNING] High storage usage!")
        elif used_percentage < 20:
            print("[SUCCESS] Low storage usage")
...
def main():
    ...
    try:
        ...
        print("\n[SUCCESS] MongoDB cleanup completed successfully!")
        print("\nNext steps:")
